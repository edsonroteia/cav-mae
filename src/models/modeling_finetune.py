...
class PatchEmbed(nn.Module):
    ...
    def __init__(self,
        ...
        print((self.tubelet_size, patch_size[0], patch_size[1]))
        self.proj = nn.Conv3d(
...
def get_sinusoid_encoding_table(n_position, d_hid, n_frames=8):
    ...
    sinusoid_table = sinusoid_table #.repeat(n_frames, axis=1)
    # import pdb ; pdb.set_trace()
    return torch.tensor(
...
class VisionTransformer(nn.Module):
    ...
    def forward_features(self, x):
        ...
        # print(x.shape, self.pos_embed.expand(B, -1, -1).shape)
        self.pos_embed = None
