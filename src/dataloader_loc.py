...
class AudiosetDataset(Dataset):
    ...
    def pro_data(self, data_json):
        for i in range(len(data_json)):
            data_json[i] = [data_json[i]['wav'], data_json[i]['labels'], data_json[i]['video_id'], data_json[i]['video_path'], str(data_json[i]['bbox'])]
    ...
    def __getitem__(self, index):
        ...
        return fbank, image, label_indices, datum['bbox']
