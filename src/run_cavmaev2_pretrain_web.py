...
import dataloaderv2_web as dataloader
import models
import numpy as np
...
# Create an instance of AudiosetDataset
audio_dataset_train = dataloader.AudiosetDataset(args.data_train, label_csv=args.label_csv, audio_conf=audio_conf)
audio_dataset_val = dataloader.AudiosetDataset(args.data_val, label_csv=args.label_csv, audio_conf=val_audio_conf)

# Create WebDataset iterables
train_iterable = audio_dataset_train.create_dataset()
val_iterable = audio_dataset_val.create_dataset()
