...
# Adjust specific values for 'val_audio_conf_'
cmd_args['val_audio_conf_freqm'] = 0
cmd_args['val_audio_conf_timem'] = 0
cmd_args['val_audio_conf_mixup'] = 0
cmd_args['val_audio_conf_mode'] = 'eval'
cmd_args['val_audio_conf_noise'] = False
...
if args.model == 'cav-mae-ft':
    ...
    audio_model = models.CAVMAEv2M3FT(label_dim=args.n_class, modality_specific_depth=11)
else:
...
if args.skip_frame_agg == True:
    ...
    res = []
    multiframe_pred = []
    total_frames = 3 # change if your total frame is different
...
run.stop()  # don't forget to stop Neptune Run!