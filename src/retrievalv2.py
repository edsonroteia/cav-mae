...
model = '/scratch/ssml/araujo/code/cav-mae/exp/testmae02-audioset-cav-mae-balNone-lr1e-5-epoch25-bs200-normTrue-c0.01-p1-tpFalse-mr-unstructured-.75/models/best_audio_model.pth'
res = []

# for audioset
for direction in ['video', 'audio']:
    data = '/home/edson/code/cav-mae/datafilles/audioset_20k_cleaned_auto_val_retrieval.json'
