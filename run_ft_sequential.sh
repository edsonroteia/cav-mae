...
tmux send-keys -t $SESSION:0.0 "bash egs/vggsound/cluster_nodes/run_cavmae_ft_sync.sh $lr1 48 multimodal 0,1 self_attention_cls 16 True 99999 10 finetuning_vggsound $model_id True 4 16 $tr_data $te_data $label_csv" C-m
tmux send-keys -t $SESSION:0.2 "bash egs/vggsound/cluster_nodes/run_cavmae_ft_sync.sh $lr2 48 multimodal 2,3 self_attention_cls 16 True 99999 10 finetuning_vggsound $model_id True 4 16 $tr_data $te_data $label_csv" C-m
tmux send-keys -t $SESSION:0.4 "bash egs/vggsound/cluster_nodes/run_cavmae_ft_sync.sh $lr3 48 multimodal 4,5 self_attention_cls 16 True 99999 10 finetuning_vggsound $model_id True 4 16 $tr_data $te_data $label_csv" C-m
tmux send-keys -t $SESSION:0.5 "bash egs/vggsound/cluster_nodes/run_cavmae_ft_sync.sh $lr4 96 multimodal 6,7 self_attention_cls 16 True 99999 10 finetuning_vggsound $model_id True 4 16 $tr_data $te_data $label_csv" C-m
