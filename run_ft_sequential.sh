...
tmux new-window -n "lr1" "bash egs/vggsound/cluster_nodes/run_cavmae_ft_sync.sh $lr1 48 multimodal 0,1 self_attention_cls 16 True 99999 10 finetuning_vggsound $model_id True $n_register_tokens 16 $tr_data $te_data $label_csv $num_classes $lr_scheduler"
tmux new-window -n "lr2" "bash egs/vggsound/cluster_nodes/run_cavmae_ft_sync.sh $lr2 48 multimodal 2,3 self_attention_cls 16 True 99999 10 finetuning_vggsound $model_id True $n_register_tokens 16 $tr_data $te_data $label_csv $num_classes $lr_scheduler"
tmux new-window -n "lr3" "bash egs/vggsound/cluster_nodes/run_cavmae_ft_sync.sh $lr3 48 multimodal 4,5 self_attention_cls 16 True 99999 10 finetuning_vggsound $model_id True $n_register_tokens 16 $tr_data $te_data $label_csv $num_classes $lr_scheduler"
tmux new-window -n "lr4" "bash egs/vggsound/cluster_nodes/run_cavmae_ft_sync.sh $lr4 48 multimodal 6,7 self_attention_cls 16 True 99999 10 finetuning_vggsound $model_id True $n_register_tokens 16 $tr_data $te_data $label_csv $num_classes $lr_scheduler"
