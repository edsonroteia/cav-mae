...
pretrain_video_path=/home/edson/code/cav-mae/video_mae.pth

bal=None
lr=5e-5
epoch=3000
lrscheduler_start=3000
...
dataset=audioset
tr_data=/home/edson/code/cav-mae/datafilles/audioset_20k_cleaned_auto_train.json
...
CUDA_CACHE_DISABLE=1 python -W ignore ../../src/run_cavmaev2_pretrain.py --model ${model} --dataset ${dataset} \
...
--pretrain_path ${pretrain_path} --pretrain_video_path ${pretrain_video_path} \
