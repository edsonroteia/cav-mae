#!/bin/bash
#SBATCH --job-name="cavmae-as2m-con"
...
#SBATCH --output=./log/%j_contrastive_only.txt
#SBATCH --error=./log/%j_contrastive_only.err

# CAV-MAE pretraining with CONTRASTIVE OBJECTIVE ONLY (no MAE loss)
