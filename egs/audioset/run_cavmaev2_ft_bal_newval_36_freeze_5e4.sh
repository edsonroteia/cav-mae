...
CUDA_CACHE_DISABLE=1 python -W ignore ../../src/run_cavmaev2_ft_neptune.py --model ${model} --dataset ${dataset} \
...
--num-workers 64 --wandb_name frozen_36_5e-4_cavmaev2++_bal_newval