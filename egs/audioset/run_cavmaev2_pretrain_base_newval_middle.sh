...
CUDA_CACHE_DISABLE=1 python -W ignore ../../src/run_cavmaev2_pretrain_middle.py --model ${model} --dataset ${dataset} \
...
--tr_pos ${tr_pos} --masking_ratio ${masking_ratio} --mask_mode ${mask_mode} --wandb_name pretrain_cavmaev2_base_middle_5e-4
