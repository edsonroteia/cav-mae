...
#SBATCH --output=./log/%j_retrieval_scalepp.txt
...
# Output path
OUTPUT_CSV=/weka/kuehne/kqr867/code/cav-mae/egs/audioset/exp/retrieval_results/original_scalepp.csv
