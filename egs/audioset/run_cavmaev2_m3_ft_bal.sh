...
pretrain_path=/data1/edson/cavmae/finetune_models/cavmaev2_vmaev1_25ep/best_audio_model.pth
...
CUDA_CACHE_DISABLE=1 python -W ignore ../../src/run_cavmaev2_m3_ft_neptune.py --model ${model} --dataset ${dataset} \
