...
dataset=audioset
tr_data=/home/edson/code/cav-mae/datafilles/as2m_web_mp4_cleaned_cleaned.json
te_data=/home/edson/code/cav-mae/datafilles/audioset_eval_cleaned_mp4.json
...
CUDA_CACHE_DISABLE=1 python -W ignore ../../src/run_cavmaev2_pretrain_mp4.py --model ${model} --dataset ${dataset} \
