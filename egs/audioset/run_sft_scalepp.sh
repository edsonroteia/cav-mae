...
#SBATCH --error=log/%j_sft_scalepp.err
...
# Original Scale++ model (batch size 256, λ_c=0.01)
...
exp_dir=./exp/sft-scalepp-original-5e-5-bs36-epoch15-$(date +%Y%m%d_%H%M%S)
mkdir -p $exp_dir

echo "=========================================="
echo "SFT for Original Scale++ Model"
