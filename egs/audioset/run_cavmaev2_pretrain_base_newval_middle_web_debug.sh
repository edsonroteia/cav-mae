...
dataset=audioset
tr_data=/home/edson/code/cav-mae/datafilles/as2m_web_nolabels.json
te_data=/home/edson/code/cav-mae/datafilles/as2m_web_nolabels.json
...
--pretrain_path ${pretrain_path} --num-workers 0 \
